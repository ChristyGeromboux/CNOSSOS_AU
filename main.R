...
# ## TODO should this compute the average of pixels within polygons 
# # (and if so should it be weighted by area of overlap?)
# ## How expensive is this calculation
